...
public class Movie {
    ...
    private int uniqueId;  //назначаем его Первичным ключем c autoincrement - в целях сохранения оригинальной сортировки фильмов

    private int id;   //в JSON источнике у каждого фильма есть свой уникальный id
